...
<ol class="breadcrumb breadcrumb-col-pink">
    ...
    <li class="active"><i class="material-icons">layers</i> @lang('sidebar.Dishes Units')</li>
</ol>
    ...
    <div class="col-xs-12">
        <div class="card">
            <div class="header">
                ...
                <a href='{{route("menue.dishes-units.new")}}' class="btn btn-success waves-effect pull-{{revFull()}}" data-toggle="tooltip" data-placement="top" data-original-title="@lang('menue.Create New Category')">
                    <i class="material-icons">add</i>
                    <span>@lang('common.New')</span>
                </a>
            </div>
            <div class="body">
              @include('layout.tables.menue.dishes-units')
            </div>
        </div>
    </div>
    <!-- #END# Basic Examples -->
