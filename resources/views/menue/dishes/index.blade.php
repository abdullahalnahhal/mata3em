...
<ol class="breadcrumb breadcrumb-col-pink">
    ...
    <li class="active"><i class="material-icons">room_service</i> @lang('sidebar.Dishes')</li>
</ol>
    ...
    <div class="col-xs-12">
        <div class="card">
            <div class="header">
                ...
                <a href='{{route("menue.dishes.new")}}' class="btn btn-success waves-effect pull-{{revFull()}}" data-toggle="tooltip" data-placement="top" data-original-title="@lang('menue.Create New Category')">
                    <i class="material-icons">add</i>
                    <span>@lang('common.New')</span>
                </a>
            </div>
            <div class="body">
              @include('layout.tables.menue.dishes')
            </div>
        </div>
    </div>
    <!-- #END# Basic Examples -->
