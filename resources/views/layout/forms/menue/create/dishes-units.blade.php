<form action="{{lRoute('menue.dishes-units.create')}}" method="post" accept-charset="utf-8" autocomplete="off">
    @csrf
        ...
        <div class="col-sm-4">
         ...
         <div class="col-sm-4">
            <div class="form-group form-float ">
                <div class="form-line">
                    <br>
                    <input type="text" name='shortcut' class="form-control" required aria-required="true" maxlength='5' value='{{old('shortcut')}}'>
