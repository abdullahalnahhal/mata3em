<form action="{{route('clients.create')}}" method="post" accept-charset="utf-8" autocomplete="off">
    @csrf
    <div class="row clearfix">
        ...
        <div class="col-sm-4">
           <div class="form-group form-float ">
               <div class="form-line">
                   <br>
                   <input type="text" name='tel1' class="form-control" required aria-required="true" maxlength='30' value='{{old('tel1')}}'>
       ...
       <div class="col-sm-4">
          <div class="form-group form-float ">
              <div class="form-line">
                  <br>
                  <input type="text" name='tel2' class="form-control" maxlength='30' value='{{old('tel2')}}'>
    ...
    <div class="row clearfix">
        <div class="col-sm-12">
          <div class="form-group form-float ">
              <div class="form-line">
                  <textarea type="text" name='address' class="form-control no-resize" required aria-required="true" resize='false'>{{old('address')}}</textarea>
