...
@endpush
@section('title', trans('sidebar.Clients'))
@section('content')
<ol class="breadcrumb breadcrumb-col-pink">
    <li><a href="{{route('index')}}"><i class="material-icons">home</i> @lang('sidebar.Home')</a></li>
    <li class="active"><i class="material-icons">people</i> @lang('sidebar.Clients')</li>
</ol>
    ...
    <div class="col-xs-12">
        <div class="card">
            <div class="header">
                ...
                <a href='{{route("clients.new")}}' class="btn btn-success waves-effect pull-{{revFull()}}" data-toggle="tooltip" data-placement="top" data-original-title="@lang('menue.Create New Category')">
                    <i class="material-icons">add</i>
                    <span>@lang('common.New')</span>
                </a>
            </div>
            <div class="body">
              @include('layout.tables.clients.clients')
            </div>
        </div>
    </div>
    <!-- #END# Basic Examples -->
