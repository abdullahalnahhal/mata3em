...
class DishCategoriesRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        return [
            ...
            'shortcut' => 'required|string|unique:dish_categories,shortcut|max:5|min:2',
    ...
    {
        return [
          'name.required' => 'menue.Category Name Must be filled',
